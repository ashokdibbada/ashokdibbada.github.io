...
app.controller('C3Ctrl',function($scope,$state,$rootScope,localStorageService){
	...
	$scope.spec_ext_details= "<ul><li>Experienced in data cleaning,regex pattern matching and performing regression analysis in R</li><li>Performed text analytics using NLTK to evaluate importance of key metrics in the contract document</li><li>Created excel based reporting framework highlighting the optimised procurement options</li></ul>"
